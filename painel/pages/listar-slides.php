...
<div class="box-content w100">
	<h2 class="titulo-topo"><i class="fa-solid fa-photo-film"></i> Slides Cadastrados</h2>
	...
	<table>
		...
		<tr>
			...
			<td><img style="width: 100px;height: 50px;border-radius: 15px;" src="<?php echo INCLUDE_PATH_PAINEL; ?>uploads/<?php echo $value['slide']; ?>" alt=""></td>
