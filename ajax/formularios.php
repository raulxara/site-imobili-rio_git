	...
	if(isset($_POST['slug_empreendimento'])){
		...
		foreach ($imoveis as $key => $value) {
			...
			$data.='<div class="row-imoveis">
				...
				<div class="r2">
					<p><i class="fa fa-pencil"></i> Nome do imóvel: '.$value['nome'].'</p>
					<p><i class="fa-solid fa-down-left-and-up-right-to-center"></i> Área: '.$value['area'].'m²</p>
					<p><i class="fa-solid fa-dollar-sign"></i> Preço: R$'.\Painel::convertMoney($value['preco']).'</p>
				</div>
			</div><!--row-imoveis-->';
		}
